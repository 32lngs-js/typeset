...
(function () {
  ...
  function positionHandles() {
    ...
    if (par) {
      ...
      let ft = r.top - 31; if (ft < 4) ft = Math.min(r.top + 4, window.innerHeight - 24);
      frameBtn.style.left = clamp(r.left - 13, 4, window.innerWidth - 24) + 'px'; frameBtn.style.top = ft + 'px';
    }
  }
